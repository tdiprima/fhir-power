"""
Retrieves patient data from FHIR server and generates a health summary 
...
def query_fhir_discharge_summary(patient_id):
    try:
        ...
        if response.status_code == 200:
            ...
            return {
                "error": f"Failed to fetch discharge summary: {response.status_code}"
            }
    except Exception as e:
        return {"error": str(e)}
        ...
        "diabetes": [
            {
                ...
                "eligibility": "Age 18-65, diagnosed with Type 2 Diabetes",
            },
            {
                "id": "NCT789012",
                "title": "Insulin Pump Study",
                "eligibility": "Age 30-70, Type 1 or 2 Diabetes",
            },
        ],
        "hypertension": [
            {
                ...
                "eligibility": "Age 40-80, diagnosed with Hypertension",
            }
        ],
    }
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful healthcare assistant with expertise in medical data and clinical trials.",
                },
